...
const MainLayout= () => {
  const menuData:MenuData[]=useData();
    ...
    <div className="md:p-10 p-14 md:flex gap-14 w-full h-auto">
        <div className="md:w-[60%]">
            ...
            <div className="grid md:grid-cols-3 gap-6">
                {
                  menuData && menuData.map((item,index:number)=>{
